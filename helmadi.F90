...
!       open(unit=10,file='/scratch1/phmotl/ffpot',form='unformatted',
!     &      status='unknown')
!       write(10) ffpot
!       close(10)
!       open(unit=11,file='/scratch1/phmotl/ffrho',form='unformatted',
!     &      status='unknown')
!       write(11) ffrho
!       close(10)
...
!       do i = 1, 1
          ...
          knownr(numr-1,zlwb:zupb,philwb:phiupb) =                   &
               knownr(numr-1,zlwb:zupb,philwb:phiupb) -              &
               alphar(numr-1)*potr(numr,zlwb:zupb,philwb:phiupb)

!          open(unit=12,file='/scratch1/phmotl/knownr1',
!     &         form='unformatted',status='unknown')
!          write(12) knownr
!          close(12)
!          open(unit=13,file='/scratch1/phmotl/potr1',
!     &         form='unformatted',
!     &         status='unknown')
!          write(13) potr
!          close(13)
...
!          open(unit=14,file='/scratch1/phmotl/knownr2',
!     &         form='unformatted',
!     &         status='unknown')
!          write(14) knownr
!          close(14)
!          open(unit=15,file='/scratch1/phmotl/potr2',
!     &         form='unformatted',
!     &         status='unknown')
!          write(15) potr
!          close(15)
          ...
          do l = philwb, phiupb
             do k = zlwb, zupb
                do j = rlwb+1, rupb
                   knownr(j,k,l) = - four_pi * rhor(j,k,l) +         & 
                                    elambdaz(j,l)*potr(j,k,l) -      &
                                    alphaz(j)*potr(j+1,k,l) -        &
                                    betaz(j)*potr(j-1,k,l)
                enddo
             enddo
          enddo
          ! the sepcial case
          ...
          knownr(rlwb:rupb,zupb,philwb:phiupb) =                     &
               knownr(rlwb:rupb,zupb,philwb:phiupb) +                &
               gamma*potr(rlwb:rupb,zupb+1,philwb:phiupb)            

          if( isym == 1 ) then
             knownr(rlwb:rupb,zlwb,philwb:phiupb) =                  &
                   knownr(rlwb:rupb,zlwb,philwb:phiupb) +            &
                   gamma*potr(rlwb:rupb,zlwb-1,philwb:phiupb)
          endif

!          open(unit=16,file='/scratch1/phmotl/knownr3',
!     &         form='unformatted',
!     &         status='unknown')
!          write(16) knownr
!          close(16)
!          open(unit=17,file='/scratch1/phmotl/potr3',
!     &         form='unformatted',
!     &         status='unknown')
!          write(17) potr
!          close(17)
...
!          open(unit=17,file='/scratch1/phmotl/knownr4',
!     &         form='unformatted',
!     &         status='unknown')
!          write(17) knownr
!          close(17)
!          open(unit=18,file='/scratch1/phmotl/potr4',
!     &         form='unformatted',
!     &         status='unknown')
!          write(18) potr
!          close(18)
